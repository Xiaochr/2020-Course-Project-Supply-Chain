<template>
  <div id="app">
    ...
    <el-dialog title="订单详情" :visible="detailVisible" @close="closeDetail()">
      ...
      <span slot="footer">
        <el-button type="success" @click="closeDetail()">确认到库</el-button>
    ...
    <el-dialog title="新增订单" :visible="addVisible" @close="closeAdd()">
      ...
      <span slot="footer">
        <el-button type="success" @click="closeAdd()">添加原料</el-button>
        <el-button type="success" @click="closeAdd()">提交</el-button>
